...
export function DepartmentWizard({ mode = 'setup' }: DepartmentWizardProps) {
  ...
  useEffect(() => {
    logger.debug('[DepartmentWizard] Initialized with mode:', mode)
  }, [mode])
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      logger.debug('[DepartmentWizard] Creating departments:', selectedDepts.length)
      ...
      logger.error('[DepartmentWizard] Error creating departments:', error)
      toast({
        title: "Error",
